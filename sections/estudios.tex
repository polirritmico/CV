...
%---------------------------------------------------------
  \cventry
    {Ingeniero en Informática} % Degree
    {DUOC UC} % Institution
    {Santiago, Chile} % Location
    {ENE 2025 - presente} % Date(s)
    {
      \begin{cvitems} % Description(s) bullet points
        \item {Programa de especialización en Inteligencia Artificial.}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {MAR 2005 - JUL 2014} % Date(s)
    {
      \begin{cvitems} % Description(s) bullet points
        ...
        \item {Estudios técnicos en programación y electrónica del Minor en Programación e Informática.}
        \item {Tesorero del Centro de Estudiantes de Música por 3 períodos.}
      \end{cvitems}
    }
