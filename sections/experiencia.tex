...
%---------------------------------------------------------
  \cventry
    {Estudio 6/8} % Job title
    {Desarrollador Freelance} % Organization
    {Santiago, Chile} % Location
    {MAR 2021 - presente} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Software de transformación de libros a través de modelos de IA (texto a voz, traducción, etc.).}
        %\item {Software de traducción automática de eBooks a través de LLM.}
        %\item {Software de conversión automática de eBooks a través de modelos TTS (texto a voz).}
        ...
        \item {Desarrollo en Python para herramientas internas de optimización.}
        ...
        \item {Documentación en HTML, LaTeX y otros formatos generada automáticamente.}
...
\cventry
  ...
  {DIC 2022 - JUN 2023} % Date(s)
  {
    \begin{cvitems} % Description(s) of tasks/responsibilities
      ...
      \item {Trabajo con bases de datos PostgreSQL.}
      \item {Diseño y creación de tablas, queries y procedimientos PostgreSQL.}
      \item {Integración de código Python con GCP (Gmail, Drive, Sheets, etc).}
  ...
  \cventry
    ...
    {AGO 2021 - DIC 2021} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Mantención y creación de tablas y macros Office}
...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Confección de controladores \lsc{MIDI} inalámbrico de baja latencia con Arduino (C, C++).}
        \item {Pedal controlador Bluetooth para visualización de partituras.}
        \item {Diseño y modelación 3D en SketchUp.}
      \end{cvitems}
    }
